...
The scatter plot shows post-surgical symptom scores by patient number, with different markers/colors for each doctor. The figure includes:
...
ax.text(patients_df['patient'].max() * 0.98, dreamy_mean, 
        f'○ {dreamy_mean:.2f}', ha='right', va='bottom', 
        fontsize=10, color='#4E79A7', fontweight='bold', 
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', alpha=0.8, edgecolor='#4E79A7'))
ax.text(patients_df['patient'].max() * 0.98, duck_mean, 
        f'△ {duck_mean:.2f}', ha='right', va='top', 
        fontsize=10, color='#E15759', fontweight='bold',
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', alpha=0.8, edgecolor='#E15759'))
...
The scatter plot is similar to Figure 1, but uses the randomized data. The figure shows how randomization breaks the confounding relationship. It includes:
...
The scatter plot shows post-surgical outcomes as a function of initial patient severity. This figure demonstrates the power of stratification. It includes:
...
# Add shaded region from -1 to 1 on x-axis (highlighting overlap region)
...
# Add text annotations for means
ax.text(patients_df['severity'].max() * 0.98, dreamy_mean, 
        f'○ {dreamy_mean:.2f}', ha='right', va='bottom', 
        fontsize=10, color='#4E79A7', fontweight='bold', 
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', alpha=0.8, edgecolor='#4E79A7'))
ax.text(patients_df['severity'].max() * 0.98, duck_mean, 
        f'△ {duck_mean:.2f}', ha='right', va='top', 
        fontsize=10, color='#E15759', fontweight='bold',
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', alpha=0.8, edgecolor='#E15759'))
